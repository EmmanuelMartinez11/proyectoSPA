...
class ProximoTurnoPersonal extends StatelessWidget {
  final String nombres;
  final String apellidos;

  ProximoTurnoPersonal({required this.nombres, required this.apellidos});
  ...
  Future<Map<String, dynamic>?> obtenerProximoTurno(
    ...
    try {
      // Obtiene todos los turnos del personal
      List<Map<String, dynamic>> turnos =
          await turnoService.obtenerTurnosPersonal('$nombres $apellidos');
